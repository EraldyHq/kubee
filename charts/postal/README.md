...
This [Kubee Chart](../../docs/site/kubee-helmet-chart.md) installs [Postal](https://docs.postalserver.io/).
...
If [dex](../dex/README.md) is enabled and the dex postal secret (`.Values.dex.clients.postal.secret`) is not empty ,
`postal` is configured to log in via [dex](../dex/README.md).
...
* [dex](../dex/README.md)  adds Oidc Auth integration
