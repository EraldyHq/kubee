...
This [kubee crds chart](../../docs/site/crds-chart.md) installs the [prometheus](../prometheus/README.md)
[CRDs](../../docs/site/crds-chart.md).

This chart is automatically installed when the [prometheus](../prometheus/README.md) chart is installed
